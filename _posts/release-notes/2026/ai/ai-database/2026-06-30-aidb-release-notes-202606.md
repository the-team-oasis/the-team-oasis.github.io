...
Data Science Agent는 Autonomous AI Database subscription에 포함된 Oracle Machine Learning UI 안의 conversational chatbot입니다. 공식 문서 기준으로 사용자가 LLM을 제공해야 하며, 이 LLM은 third-party AI provider, OCI Generative AI Service, 또는 privately hosted model 중 하나일 수 있습니다.
