...
title: "OCI Identity Domain 에서 사용자, 그룹, 정책 관리하기 (RedWood 스타일)"
...
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-1.png " ")

**구획 생성** 버튼을 클릭하고, 입력창에 다음과 같이 입력합니다.
* 구획명: Sandbox
* 설명: Sandbox 사용자를 위한 구획

![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-2.png " ")
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-3.png " ")

#### 2. 기본 도메인 (Default Domain)에 사용자 추가
두 번째로 기본 도메인에 사용자를 추가합니다. 메뉴에서 **ID & 보안 (Identity & Security) > 도메인(Domain)**을 선택합니다. 

![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-4.png " ")

이동한 화면에서 기본 도메인 (Default Domain)을 선택합니다. 만약 Default 도메인이 보이지 않은 경우 왼쪽 하단에서 루트 구획을 선택합니다.

![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-5.png " ")

이동한 도메인 화면에서 상단 **사용자** 탭을 클릭한 후 **생성**를 클릭하여 사용자를 생성합니다.
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-6.png " ")
...
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-7.png " ")
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-8.png " ")
...
사용자 관리 탭에서 하단으로 스크롤하면 **그룹** 섹션을 확인할 수 있습니다. **그룹 생성**을 클릭하고, 다음과 같이 입력한 후 생성을 클릭합니다.
* 그룹명: SandboxGroup
* 설명: Sandbox 구획을 사용하기 위한 그룹
* 사용자: 위에서 추가한 기본 도메인 사용자

![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-9.png " ")
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-10.png " ")
...
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-11.png " ")

**정책 생성** 버튼을 클릭한 후 다음과 같이 입력합니다.
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-12.png " ")

* 이름: SandboxPolicy
* 설명: 사용자에게 Sandbox 구획에 대한 모든 권한 부여
* 수동 편집기 표시 클릭 -> 직접 정책을 입력
* 정책 작성기에 다음 구문 입력
...
![](/assets/img/getting-started/2026/identity-domain/oci-identity-domain-13.png " ")
