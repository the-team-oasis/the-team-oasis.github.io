...
![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-1.png)

기본 선택화면에서 인스턴스 이름을 입력하고 이미지 (여기서는 Oracle Linux 8)를 선택하며, 인스턴스에서 사용하기 위한 VCN과 Subnet (Public)을 선택합니다.
![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-2.png)
...
![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-3.png)
...
![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-4.png)

**Add Ingress Rules**을 선택합니다.

![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-5.png)
...
![]({{site.urlblogimg2022_2023}}/assets/img/getting-started/2022/compute-firewall-6.png)
