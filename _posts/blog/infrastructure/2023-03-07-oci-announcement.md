...
알람 유형은 아래와 같습니다.
- 필수 조치: 환경 내에서 특정 조치를 수행해야 합니다.
- 긴급 변경: 계획되지 않았지만 긴급한 환경과 관련된 변경이 발생하는 기간이 있습니다.
- 긴급 유지 보수 연장: 긴급 유지 보수 기간은 이전에 연락한 기간보다 연장되었습니다.
- 긴급 유지 보수 일정 변경: 비상 유지 보수 기간은 늦은 시간 또는 날짜로 연기되었습니다.
- 권장 조치: 환경 내에서 수행할 특정 조치가 있지만 조치는 필수는 아닙니다.
- 계획적 변경: 환경과 연관된 계획된 변경이 발생하는 기간이 있습니다.
- 계획적 변경 연장: 예약된 변경 기간은 이전에 연락한 기간보다 연장되었습니다.
- 계획적 변경 일정 변경: 환경에 대해 계획된 변경사항은 늦은 시간 또는 날짜로 연기되었습니다.
- 이벤트 알림: 최근에 발생했거나 활성으로 발생한 환경에 대한 영향이 큰 변경.
- 스케줄 된 유지 보수: 계획 유지 보수 활동이 환경에서 실행되는 기간이 있습니다. 유지보수 활동에는 서비스를 다시 시작하거나 유사한 영향을 주는 기타 조치가 포함될 수 있습니다.
- 긴급 유지 보수 완료: 사용자 환경에 영향을 미치는 긴급 유지 보수가 완료되었으며 정상 작동이 재개되었습니다.
- 계획적 변경 완료: 환경에 대한 계획 변경이 완료되었으며 정상적인 운영이 재개되었습니다.
- 정보: 유용하다고 생각되는 정보가 있지만 긴급하지 않으며 사용자 측에 조치가 필요하지 않습니다.


Oracle Cloud Infrastructure Compute 인스턴스에 영향을 미치는 알림은 14일 전에 알림을 받을 수 있습니다. 
공지사항에 설명된 조치를 지연해야 하는 경우 지원팀에 문의하여 공지사항 에 나열된 대체 날짜 중 하나를 요청할 수 있습니다.
