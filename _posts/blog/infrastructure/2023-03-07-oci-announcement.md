...
AS(Announcemnet Service)는 특정 테넌트에 대상으로 공지를 보내며, 고객은 콘솔에서 볼수 있을뿐 아니라 이메일/SMS/기타 채널을 통해서 수신을 신청할 수 있습니다. 모든 서비스 중단의 경우에는 AS를 통해 전송되며, OCI Status에 게시물이 있으면 AS를 통해 쌍으로 통신이 전송됩니다.
AS는 유비보수, 정보 및 기타 여러 유형을 공지를 고객에게 전송합니다.
