...
| 단일 관리 데이터베이스 모니터링  	                                        | 성능 허브(Performance Hub)콘솔을 통해 ASH 분석, AWR Report, 그리고 SQL 머니터링 기능이 제공됨   	                                           |
...
* SQL 모니터링
  * SQL 모니터링 탭에는 모니터링되는 SQL 문을 표시하는 테이블이 포함되어 있습니다. 이 탭을 보려면 성능 허브 페이지 에서 SQL 모니터링을 클릭하십시오.
