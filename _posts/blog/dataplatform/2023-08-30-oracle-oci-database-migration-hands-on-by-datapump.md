...
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/01_datapump_export_dir_create_01.png)
...
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/02_datapump_export_dir_create_02.png)
...
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/03_datapump_export_precheck.png)
...
- 수행 결과 (수행 시 DBA 계정과 Password 입력 필요)
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/04_datapump_export_start.png)
- Export 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/05_datapump_export_end.png)
...
```
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/06_datapump_target_export_directory.png)

- SOURCE DB 의 '/u01/export' Directory 의 dump 파일을 로컬디스크로 다운받습니다.
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/07_datapump_data_move.png)

- 다운받은 dump 파일을 TARGET DB 의 '/u01/export' 에 dump 파일을 업로드합니다.
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/08_datapump_data_move_upload.png)
...
```
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/09_datapump_data_change_owner.png)
...
```
- 수정 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/10_datapump_modify_tnsnames.png)
...
```
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/11_datapump_tnsping.png)
...
```
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/12_datapump_grant.png)
...
```
- 수행 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/13_datapump_import_permission.png)
...
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/14_datapump_import.png)
...
```
- 실생 결과
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/15_datapump_import_result.png)

- SQLDeveloper 를 통한 Import 데이터 확인
![Terminal](/assets/img/dataplatform/2023/oracle/datapump/16_datapump_import_result_sqldev.png)
